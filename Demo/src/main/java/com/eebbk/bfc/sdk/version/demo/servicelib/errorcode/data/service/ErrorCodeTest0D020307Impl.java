...
public class ErrorCodeTest0D020307Impl extends AServiceErrorCodeTest {

    @Override
    public String getErrorCode() {
        return ErrorCode.SERVICE_INSTALL_FAILED_CONTEXT_NULL;
    }
    ...
    public void run(Context context, OnCheckErrorCodeListener l) {
        ...
        bfcVersion.installApk(null, new VersionInfo(context, 0, "remoteVersionName", 0,
