...
public class ErrorCodeTest0D020306Impl extends AServiceErrorCodeTest {

    @Override
    public String getErrorCode() {
        return ErrorCode.SERVICE_INSTALL_FAILED_INFO;
    }
    ...
    public void run(Context context, OnCheckErrorCodeListener l) {
        ...
        bfcVersion.installApk(context, new VersionInfo(context, 0, "remoteVersionName", 0,
                "information", new File(getTestPath() + "eleme_107.apk"), 0, "curVersionName",
                "md5", "packageName", 0));
    }
}
